...
export interface EventoDisplay { id: string; titulo: string; slug: string; descricao: string; data: string; hora: string; local: string; tipo: string; imagem_url?: string; video_url?: string; featured?: boolean; created_at: string; sections: SectionData[] }
const mapEvento = (e: Evento): EventoDisplay => ({ id: e.id, titulo: e.titulo, slug: e.slug || e.id, descricao: e.descricao || '', data: e.data, hora: e.hora || '', local: e.local || '', tipo: e.tipo || 'conferencia', imagem_url: resolveMediaUrl(e.imagem_url), video_url: resolveMediaUrl(e.video_url), featured: e.featured, created_at: e.created_at, sections: e.sections || [] })
