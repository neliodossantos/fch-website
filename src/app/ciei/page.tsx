        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-6">
              ...
              <p className="text-gray-600">Publicações (2020-2026)</p>
            </div>
            <div className="p-6">
              <p className="text-4xl font-bold text-primary">59</p>
              <p className="text-gray-600">Artigos em Revistas Indexadas</p>
            </div>
            <div className="p-6">
              <p className="text-4xl font-bold text-primary">4</p>
              <p className="text-gray-600">Linhas de Investigação</p>
            </div>
          </div>

          <div className="max-w-3xl mx-auto mt-12 bg-secondary/10 rounded-lg p-6 text-center">
